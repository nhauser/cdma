...
/**
 * This class <b>ConfigCriteria</b> gather a set of criterion. It is used to determine wether a
 * IDataset is matching to <b>ConfigDataset</b>'s criteria.
 * <p>
 * To be considered as matching the IDataset must be returning <b>CriterionValue.TRUE</b> at the
 * evaluation of each <b>ConfigParameter</b>
 * <p>
...
public class ConfigCriteria {
    ...
    /**
     * Tells if the given IDataset matches this ConfigCriteria. All clause must be respected by the
     * given IDataset.
     * 
