...
/**
 * The ILogicalGroup is an IObject that is purely <b>virtual</b>. Its existence is 
 * correlated to the IDictionary.
 * <p>
 * A standard CDM dictionary make a link between a key and a path. Now let's imagine
...
public interface ILogicalGroup extends IContainer {
     ...
     * 			entry of the dictionary (can carry filters)
     * 
     * @return a list of DataItem that match the key
     */
	 ...
	 * @param key
	 *          IKey for which we want the parameters values
	 * @return
