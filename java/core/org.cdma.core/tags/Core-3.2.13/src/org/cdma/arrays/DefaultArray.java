...
public abstract class DefaultArray implements IArray {
     ...
     */
    static public IArray instantiateDefaultArray(final String factory, final Object storage, final int[] shape ) throws InvalidArrayTypeException {
        IArray result = null;
     ...
     * @throws InvalidArrayTypeException
     */
    static public IArray instantiateDefaultArray(final String factory, final Object storage ) throws InvalidArrayTypeException {
        IArray result = null;
    ...
    protected DefaultArray( final String factory, final Class<?> clazz, final int[] shape ) throws InvalidArrayTypeException {
        mLock    = false;
        mClazz   = clazz;
    ...
    protected DefaultArray( final String factory, final Object array ) throws InvalidArrayTypeException {
        if( array == null ) {
    ...
    protected DefaultArray( final DefaultArray array ) {
    ...
    @Override
    public DefaultSliceIterator getSliceIterator(final int rank) throws ShapeNotMatchException, InvalidRangeException {
    ...
    public IArrayMath getArrayMath() {
        return new DefaultCompositeArrayMath(this, Factory.getFactory(mFactory));
    }
