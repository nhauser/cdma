...
public class DefaultArrayMatrix extends DefaultArray {
     ...
     */
    public DefaultArrayMatrix( final String factory, final Object storage ) throws InvalidArrayTypeException {
    ...
    protected DefaultArrayMatrix( final DefaultArrayMatrix array ) throws InvalidArrayTypeException {
        super( array );
        mData = array.getStorage();
    }

    @Override
    public boolean getBoolean(final IIndex index) {
        boolean result;
    ...
    @Override
    public byte getByte(final IIndex index) {
        byte result;
    ...
    @Override
    public char getChar(final IIndex index) {
        char result;
    ...
    @Override
    public double getDouble(final IIndex index) {
        double result;
    ...
    @Override
    public float getFloat(final IIndex index) {
        float result;
        if( Double.TYPE.equals( getElementType() ) ) {
            int[] pos = projectCoordinates(index);
            Object array = getMostVaryingRaw( pos, getStorage() );
    ...
    @Override
    public int getInt(final IIndex index) {
        int result;
    ...
    @Override
    public long getLong(final IIndex index) {
        long result;
    ...
    @Override
    public short getShort(final IIndex index) {
        short result;
    ...
    @Override
    public void setBoolean(final IIndex index, final boolean value) {
        if( Boolean.TYPE.equals( getElementType() ) ) {
            int[] pos = projectCoordinates(index);
            Object array = getMostVaryingRaw( pos, getStorage() );
    ...
    @Override
    public void setByte(final IIndex index, final byte value) {
        if( Byte.TYPE.equals( getElementType() ) ) {
            int[] pos = projectCoordinates(index);
            Object array = getMostVaryingRaw( pos, getStorage() );
    ...
    @Override
    public void setChar(final IIndex index, final char value) {
        if( Character.TYPE.equals( getElementType() ) ) {
            int[] pos = projectCoordinates(index);
            Object array = getMostVaryingRaw( pos, getStorage() );
    ...
    @Override
    public void setDouble(final IIndex index, final double value) {
        if( Double.TYPE.equals( getElementType() ) ) {
            int[] pos = projectCoordinates(index);
            Object array = getMostVaryingRaw( pos, getStorage() );
    ...
    @Override
    public void setFloat(final IIndex index, final float value) {
    ...
    @Override
    public void setInt(final IIndex index, final int value) {
        if( Integer.TYPE.equals( getElementType() ) ) {
            int[] pos = projectCoordinates(index);
            Object array = getMostVaryingRaw( pos, getStorage() );
    ...
    @Override
    public void setLong(final IIndex index, final long value) {
        if( Long.TYPE.equals( getElementType() ) ) {
            int[] pos = projectCoordinates(index);
            Object array = getMostVaryingRaw( pos, getStorage() );
    ...
    @Override
    public void setObject(final IIndex index, final Object value) {
        int[] pos = projectCoordinates(index);
        Object array = getMostVaryingRaw( pos, getStorage() );
    ...
    @Override
    public void setShort(final IIndex index, final short value) {
        if( Short.TYPE.equals( getElementType() ) ) {
            int[] pos = projectCoordinates(index);
            Object array = getMostVaryingRaw( pos, getStorage() );
     ...
     */
    private <T> Object getMostVaryingRaw( final int[] position, final T data ) {
        return getMostVaryingRaw( position, data, 0 );
    }

    @SuppressWarnings("unchecked")
    private <T, C> Object getMostVaryingRaw( final int[] coordinates, final T data, final int depth ) {
        Object result = data;
     ...
     * @return an Object that is an array of type T
     */
    private int[] projectCoordinates( final IIndex index ) {
