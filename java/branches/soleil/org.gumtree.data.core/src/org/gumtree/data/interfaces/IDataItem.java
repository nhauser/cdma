...
public interface IDataItem extends IContainer, Cloneable {
   ...
   * 
   * @param section List of type Range, with size equal to getRank(). Each Range
   ...
   * Set the data cache.
   * 
   * @param cacheData IArray object
   * @param isMetadata : synthesised data, set true if must be saved in NcML output
