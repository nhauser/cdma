...
/**
 * @bried The CDMA is an API that provides an access to data sources regardless their format or structure.
 * 
 ...
 * <br/> - an plug-in auto detection mechanism to not care of which plug-in a data source should refer to (see: the Factory class)
