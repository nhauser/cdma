...
public interface IGroup extends IContainer {
   ...
   * The Object can be a CDMA Group, CDMA DataItem. If there are more than one
   ...
   * Group, CDMA DataItem, or CDMA Attribute
   * 
   ...
   * can be a CDMA Groups, CDMA DataItems, or CDMA Attributes
   * 
   ...
   * 
   * @param dimension CDMA Dimension
   * @return CDMA Dimension type 
   */
   ...
   * @param dataItem DataItem object 
   ...
   * original ones.
   * 
   * @return new Group CDMA group object 
   */
  @Override
  IGroup clone();
