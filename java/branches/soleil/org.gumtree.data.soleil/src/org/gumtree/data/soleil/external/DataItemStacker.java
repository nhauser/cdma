...
public final class DataItemStacker {
	 ...
	 * @return
	 */
	public IDataItem stackDataItems(IContext context) {
		...
		if( !list.isEmpty() ) {
			...
			NxsGroup parent = (NxsGroup) dataset.getRootGroup();
			item = new NxsDataItem( list.toArray(new NxsDataItem[list.size()]), parent, dataset );
		}
		return item;
	}
