...
public class DataItem implements Cloneable {
    public class Data<T> {
        ...
        protected Data(T tValue) {
            m_tValue = tValue;
            m_cType = (Class<T>) tValue.getClass();
        }
    ...
    public void setSlabSize(int[] iSlab) {
        mDimData = iSlab.clone();
    }
    ...
    public String getUnit() {
        Object attrValue = getAttribute("units");
        return attrValue == null ? null : attrValue.toString();
    }

    public String getDesc() {
        Object attrValue = getAttribute("description");
        return attrValue == null ? null : attrValue.toString();
    }

    public String getTime() {
        Object attrValue = getAttribute("timestamp");
        return attrValue == null ? null : attrValue.toString();
    }

    public String getFormat() {
        Object attrValue = getAttribute("format");
        return attrValue == null ? null : attrValue.toString();
    }
    ...
    public <T> void setUnit(T sUnit) {
        setAttribute("units", sUnit);
    }

    public <T> void setDesc(T sDesc) {
        setAttribute("description", sDesc);
    }

    public <T> void setTime(T sTime) {
        setAttribute("timestamp", sTime);
    }

    public <T> void setFormat(T sForm) {
        setAttribute("format", sForm);
    }

    public <T> void setName(T sName) {
    ...
    public HashMap<String, Data<?>> getAttributes() {
        return mAttribs;
    }
