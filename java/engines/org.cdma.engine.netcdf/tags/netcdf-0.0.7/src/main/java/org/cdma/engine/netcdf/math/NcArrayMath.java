package org.cdma.engine.netcdf.math;
...
public class NcArrayMath extends ArrayMath {
    ...
    public IArrayMath matInverse() throws ShapeNotMatchException {
        ...
        return new NcArray(matrix.getArrayStorage(), getFactory().getName()).getArrayMath();
    }
    ...
    public IArrayMath matMultiply(final IArray newArray)
        ...
        try {
            ...
            result = new NcArrayMath(new NcArray(resultMatrix.getArrayStorage(), factory.getName()), factory);
        } catch (Exception e) {
    ...
    public IArrayMath normalise() {
        MAVector vector = new MAVector(getNcArray().getArray());
        vector.normalize();
        return new NcArray(vector.getArrayStorage(), getFactory().getName()).getArrayMath();
    }
