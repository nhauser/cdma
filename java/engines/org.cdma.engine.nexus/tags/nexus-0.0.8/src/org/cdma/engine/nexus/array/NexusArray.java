...
public final class NexusArray implements IArray {
    ...
    public NexusArray(String factoryName, Object oArray, int[] iShape) {
        ...
        if (iShape.length == 1) {
            ...
            mIsRawArray = (oArray.getClass().isArray() && !(java.lang.reflect.Array.get(oArray, 0).getClass().isArray()));
        }
        mN4TDataItem = null;
...
//            }
    ...
    /**
     * Set the given object into the targeted cell by given index (eventually using auto-boxing).
