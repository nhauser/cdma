...
public class NxsIndexMatrix extends NxsIndex {
	private NxsIndex m_indexArrayData;
	private NxsIndex m_indexStorage;
	 ...
	 */
	public NxsIndexMatrix(int matrixRank, int[] shape, int[] start, int[] length) {
		super(shape, start, length);
		m_indexArrayData = new NxsIndex(
	...
	public NxsIndexMatrix(NxsIndexMatrix index) {
		super(index);
		
		m_indexArrayData = new NxsIndex(index.m_indexArrayData);
		m_indexStorage = new NxsIndex(index.m_indexStorage);
    }
	
	public NxsIndexMatrix(int[] matrix, int[] storage) {
		super(
				concat(matrix, storage)
		);
		
		m_indexArrayData = new NxsIndex(matrix);
		m_indexStorage   = new NxsIndex(storage);
	}
	
	public NxsIndexMatrix(int matrixRank, IIndex index) {
    ...
    @Override
    public IIndex clone() {
    	NxsIndexMatrix index = new NxsIndexMatrix(this); 
    	return index;
    }
