...
public final class NxsIndex implements IIndex, Cloneable {
    ...
    private final NexusIndex mIndexStorage; // View describing each array storage
    ...
    public NxsIndex(int matrixRank, int[] shape, int[] start, int[] length) {
        ...
        mIndexStorage = new NexusIndex(NxsFactory.NAME, java.util.Arrays.copyOfRange(shape, matrixRank, shape.length),
