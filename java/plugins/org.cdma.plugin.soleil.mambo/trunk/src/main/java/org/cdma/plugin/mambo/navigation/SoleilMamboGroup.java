...
public class SoleilMamboGroup extends AbstractGroup {
    ...
    public SoleilMamboGroup(SoleilMamboDataset dataset, SoleilMamboGroup parent, XmlGroup xmlGroup,
            ArchivingGroup arcGroup) throws BackupException {
    ...
    public IGroup clone() {
        ...
        try {
            result = new SoleilMamboGroup((SoleilMamboDataset) getDataset(), (SoleilMamboGroup) getParentGroup(),
                    getShortName());
    ...
    private SoleilMamboGroup initGroupChild(SoleilMamboDataset dataset, String path, XmlGroup xmlGroup)
            throws NoResultException, BackupException {
        SoleilMamboGroup result = null;
