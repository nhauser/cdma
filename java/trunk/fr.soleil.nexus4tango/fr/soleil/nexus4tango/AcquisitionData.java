...
public class AcquisitionData {
	...
	private DataSet prepareReadDataSet(DataSet dsData) throws NexusException
	{
	  ...
	  * 
	  * @param sClassName
	  *            wanted class name to be listed (NXgroup, NXdata...)
	  ...
	  * 
	  * @param sClassName
	  *            the name of class on which selection test will be done
	  * @param bEqualityTest
	  *            boolean value filtering nodes having sClassName (if true), or
	  ...
	  * 
	  * @param sClassNames
	  *            array of class names on which selection filter will be applied
	  * @param bEqualityTest
	  *            kind of selection on class name
	  * @return HashSet of NeXus nodes
	  */
