...
public final class Factory {
    ...
    /**
     * Set the name of the current experiment that will be active for
     * the Extended Dictionary mechanism.
     * 
     * @param experiment name
     */
    public static void setActiveExperiment(String experiment) {
        CDM_EXPERIMENT = experiment;
    }
    
    /**
     * Returns the name of the current experiment that is active for
     * the Extended Dictionary mechanism.
     * 
    ...
    /**
     * According to the currently defined experiment, this method will return the path
     * to reach the concept dictionary. It means the file where
     * is defined every physical concepts specific to that experiment.
     * 
     * @return the path to the common concept file  or null if not found
     * @note The file name is as following: getDictionariesFolder() + getActiveView() + "_dictionary.xml"
     * @see Factory.getConceptCommonDictionaryPath()
     */
    public static String getPathExperimentConceptDictionary() {
        String sDict = getDictionariesFolder();
        String sFile = ( getActiveExperiment() + "_" + FILE_CONCEPT_NAME + ".xml").toLowerCase();
     ...
     */
    public static LogicalGroup createLogicalGroup(IDataset dataset, IKey key) {
